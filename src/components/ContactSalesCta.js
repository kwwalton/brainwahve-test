...
function ContactSalesCta(props) {
  return (
    <div className="flex pt-[40px] md:pt-0 pb-[100px] md:pb-0 bg-contact-sales-cta bg-cover bg-no-repeat bg-bottom h-full">
      <div className="w-[530px] my-auto mx-[40px] md:mx-[60px] lg:mx-[135px]">
        <h2 className="text-gray-800 text-[20px] font-medium mb-[20px]">
          Find your perfect match
        </h2>
        <p className="text-gray-800 text-[18px] mb-[30px] leading-[36px]">
        ...
        <p className="text-gray-800 text-[18px] mb-[20px]">
